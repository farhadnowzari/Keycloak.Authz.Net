...
public class KeycloakAuthzFilter : IAsyncAuthorizationFilter
{
    ...
    private AuthzContext AuthzContext { get; }
    ...
    public KeycloakAuthzFilter(AuthzContext kcAuthzContext, string[] permissions, PermissionResourceFormat? resourceFormat = null, PlaceholderSource placeholderSource = PlaceholderSource.Params)
    {
